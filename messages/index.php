...
<!DOCTYPE html>
	<head>
		<title>Messages - TDBDNH: Revived</title>
	</head>
	<body>
		<div id="body">
				...
				<tbody>
					...
					<?php
						while($messageRow=$result->fetch_assoc()) {
							...
							<tr>
								<td>
									<center><a style="font-weight: <?php echo $weight; ?> ; color:#000;" href="message?id=<?php echo $messageRow['id']; ?>"><?php echo htmlentities($messageRow['title']); ?></a></center></td>
							<td>
								<center><a style="font-weight:<?php echo $weight; ?>; color:#000;" href="message?id=<?php echo $messageRow['id']; ?>"> <?php echo htmlentities(substr($messageRow['message'],0,100)); ?></a></center></td>
							<td><a style="<?php echo 'font-weight:'.$weight; ?>; color:#000;" href="/user?id=<?php echo $messageRow['author_id']; ?>">
							<center><img width="50px;" src="/images/avatars/<?php echo $senderRow['id'].'.png?c='.$senderRow['avatar_id']; ?>"><br><?php echo $senderRow['username'] ?></a></center></td>
