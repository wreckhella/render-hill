<?php
    ...
    if (isset($_POST['Purge'])) {
    	$purgeSQL = "UPDATE `avatar` SET `shirt`='0', `pants`='0', `tshirt`='0', `hat1`='0', `hat2`='0', `hat3`='0', `hat4`='0', `hat5`='0', `tool`='0', `head`='0', `face`='0', `cache`='0' WHERE `user_id`='$userId'";
    ...
    <div id="column" style="width: 55%;float:right;">
      <div id="box" style="width:100%;">
        ...
        <div style=" color: black; font-weight: 600; padding-bottom: 15px;text-align:center;">
          <span><a class="getPageClicker" onclick="getPage('hat', 0)" style=" color: #c3cdd2; font-weight: 600;">Hats</a></span>
          <span>|</span> <span><a class="getPageClicker" onclick="getPage('face', 0)" style=" color: #c3cdd2; font-weight: 600;">Faces</a></span>
          <span>|</span> <span><a class="getPageClicker" onclick="getPage('tool', 0)" style=" color: #c3cdd2; font-weight: 600;">Tools</a></span>
          <span>|</span> <span><a class="getPageClicker" onclick="getPage('shirt', 0)" style=" color: #c3cdd2; font-weight: 600;">Shirts</a></span>
          <span>|</span> <span><a class="getPageClicker" onclick="getPage('pants', 0)" style=" color: #c3cdd2; font-weight: 600;">Pants</a></span>
          <span>|</span> <span><a class="getPageClicker" onclick="getPage('tshirt', 0)" style=" color: #c3cdd2; font-weight: 600;">T-Shirts</a></span>
	  <span>|</span> <span><a class="getPageClicker" onclick="getPage('head', 0)" style=" color: #c3cdd2; font-weight: 600;">Heads</a></span>
          <span>|</span> <span><a href="/shop/upload/" style=" color: #c3cdd2; font-weight: 600;">Create</a></span><br>
          </div>
          <div id="inventory" style="margin-left:25px;text-align:center; color:#c3cdd2;">
          <?php 
          ...
          if (mysqli_num_rows($crate) > 0) { 
            while($crateRow = mysqli_fetch_assoc($crate)) {
                // Get item information
                  ...
                  ?>
					<div style="clear: both;margin: 10px;width: 142px;display:inline-block; color:#c3cdd2;">
						<a href="/shop/item.php?id=<?php echo $itemRow['id']; ?>"></a>
							...
							?><?php if ($itemRow['type'] == "shirt") {
								?>
								style="padding-left:10px;padding-right:10px;width:120px;"
								<?php } else{}; ?> src="/shop/thumbnails/<?php echo $itemRow['id']; ?>.png"></a>
							<span style="text-align:center;display:inline-block;float:left;width: 100%;padding-left: 0;padding-right: 0; color:#c3cdd2;">
								<a class="shopTitle" style="color:#c3cdd2;" href="/shop/item.php?id=<?php echo $itemRow['id']; ?>">
...
<div style="position: absolute;left: 40.2%;top: 226px;">
    ...
    <div id="column" style="width:394px; float:left;">
      ...
      <h5>Your Avatar:</h5>
      <div id="avatar"><img src="/images/avatars/<?php echo $userRow['id']; ?>.png?c=<?php echo $userRow['avatar_id']; ?>"></div>
      <button onClick="avatarRedraw()">Refresh </button>
      <button onClick="tdbhd()">Headshot Render (for dashboard)</button>
      <span>|</span>
  ...
  <script>
	window.onload = function() {
  	...
  	document.getElementById("avatar").innerHTML = '<iframe style="width:235px;height:280px;border:0px;" src="/customize/rendering/<?php if ($_SESSION['id'] == 4) { echo 'isaiah'; } ?>"></iframe>';
  	};

//custom renders!

  	function tdbtp() {
  	document.getElementById("avatar").innerHTML = '<iframe style="width:235px;height:280px;border:0px;" src="/customize/rendering/tdbtp/<?php if ($_SESSION['id'] == 4) { echo 'isaiah'; } ?>"></iframe>';
  	};
	function tdbr() {
  	document.getElementById("avatar").innerHTML = '<iframe style="width:235px;height:280px;border:0px;" src="/customize/rendering/tdbr/<?php if ($_SESSION['id'] == 4) { echo 'isaiah'; } ?>"></iframe>';
  	};
	function tdbz() {
  	document.getElementById("avatar").innerHTML = '<iframe style="width:235px;height:280px;border:0px;" src="/customize/rendering/tdbz/<?php if ($_SESSION['id'] == 4) { echo 'isaiah'; } ?>"></iframe>';
  	};
	function tdbh() {
  	document.getElementById("avatar").innerHTML = '<iframe style="width:235px;height:280px;border:0px;" src="/customize/rendering/tdbh/<?php if ($_SESSION['id'] == 4) { echo 'isaiah'; } ?>"></iframe>';
  	};
	function tdbc() {
  	document.getElementById("avatar").innerHTML = '<iframe style="width:235px;height:280px;border:0px;" src="/customize/rendering/tdbc/<?php if ($_SESSION['id'] == 4) { echo 'isaiah'; } ?>"></iframe>';
  	};
        function tdbw() {
  	document.getElementById("avatar").innerHTML = '<iframe style="width:235px;height:280px;border:0px;" src="/customize/rendering/tdbw/<?php if ($_SESSION['id'] == 4) { echo 'isaiah'; } ?>"></iframe>';
  	};
        function tdb16() {
  	document.getElementById("avatar").innerHTML = '<iframe style="width:235px;height:280px;border:0px;" src="/customize/rendering/tdb16/<?php if ($_SESSION['id'] == 4) { echo 'isaiah'; } ?>"></iframe>';
  	};
	function tdbs() {
  	document.getElementById("avatar").innerHTML = '<iframe style="width:235px;height:280px;border:0px;" src="/customize/rendering/tdbs/<?php if ($_SESSION['id'] == 4) { echo 'isaiah'; } ?>"></iframe>';
  	};
	function tdbn() {
  	document.getElementById("avatar").innerHTML = '<iframe style="width:235px;height:280px;border:0px;" src="/customize/rendering/secret/<?php if ($_SESSION['id'] == 4) { echo 'isaiah'; } ?>"></iframe>';
  	};
	function tdbhd() {
  	document.getElementById("avatar").innerHTML = '<iframe style="width:235px;height:280px;border:0px;" src="/customize/rendering/headshot/<?php if ($_SESSION['id'] == 4) { echo 'isaiah'; } ?>"></iframe>';
  	};
//end of custom renders
