				...
				if($imgSize < 2097152) {
					if(isset($_POST['name'])) {
						if(isset($_POST['bits']) or isset($_POST['bucks'])) {
							...
							move_uploaded_file($imgTmp,"../assets/tools/".shopItemHash($itemID).".png");
							move_uploaded_file($objTmp,"../assets/tools/".shopItemHash($itemID).".obj");
							
							header('Location: ../item?id='.$itemID.'&toolrender');
						} else {
...
<!DOCTYPE html>
	<head>
		<title>Upload Tool - TDBDNH: Revived</title>
	</head>
	<body>
		<div id="body">
			<div id="box">
