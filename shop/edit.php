...
if(isset($_POST['submit'])) {
	if(isset($_POST['name']) && isset($_POST['description']) && isset($_POST['bits']) && isset($_POST['bucks'])) {
		if(isset($_POST['special']) && $power >= 5 && ($shopRow['type'] == 'hat' || $shopRow['type'] == 'tool' || $shopRow['type'] == 'face')) {
			$special = 'yes';
...
<!DOCTYPE html>
	<head>
		<title>Edit Item - TDBDNH: Revived</title>
	</head>
	<body>
		<div id="body">
			<div id="box">
				...
				<img src="/shop/thumbnails/<?php echo $searchRow['id']; ?>.png" style="float:right;margin:10px;">
			</div>
		</div>
	</body>
</html>